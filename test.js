...
const templates = {
    ...
    I certify that {studentName} {studentCertNumber} has received and logged training time within 2 calendar-months preceding the month of application in preparation for the practical test and {studentName} is prepared for the required practical test for the issuance of __________ certificate. 
    Date: {date} 	         Signature:_____________
    {instructorName}           {instructorCertNumber}          Exp. {instructorCertExpDate}`,
    ...
    "Prerequisites for IR practical tests":`  
    ...
    I certify that  {studentName} {studentCertNumber} has been given training specified by SFAR 73, section 2(b)(2)(ii)(A–D) for Robinson R-44 helicopters  and is proficient to act as pilot in command. An annual flight review must be completed by ______(date 12 calendar-months after date of this endorsement) unless the requirements of  SFAR 73, section 2(b)(2)(i) are met.  
    Date: {date}          Signature:_____________
    {instructorName}           {instructorCertNumber}          Exp. {instructorCertExpDate}`,
